...
const raisedToTheThird = (arr) => {
  // Solution code here...
  let array = [];
  arr.forEach( (numFunc) => array.push(Math.pow(numFunc,3)))
  return array
};
...
const addOne = (arr) => {
  // Solution code here...
  let mapArray = arr.map( number => (number+1))
  return mapArray
};
...
const addQuestion = (arr) => {
  // Solution code here...
  let newArray = arr.map(srtan => srtan + '?')
  return newArray
};
...
const forEachTwoToThe = (arr) => {
  // Solution code here...
  let eachArray = [];
  arr.forEach(number => eachArray.push(Math.pow(2,number)))
  return eachArray;
};
