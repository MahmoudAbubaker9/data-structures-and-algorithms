...
const allUpperCase = (arr) => {
    // Solution code here...
    let uppArry = [];
    arr.forEach(uppValue => uppArry.push(uppValue.toUpperCase()));
    return uppArry;
};
...
const greeting = (word) => {
    // Solution code here...
    // let Array = [];
    // word.forEach(uppValue => Array.push(uppValue.toUpperCase() + '!'));
...
const speaker = (words, callback) => {
    // Solution code here...
    let Array = [];
    words.forEach(value => Array.push(callback(value)));
    return Array
};
